...
#    Updated: 2025/10/25 18:27:41 by joafern2         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
prepare_resources.c xpms.c color_management.c images.c screens.c resolution.c \
resolution_helpers.c raycaster.c frame_managment.c)
