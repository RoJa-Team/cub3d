...
/*   Updated: 2025/10/25 20:08:58 by rafasant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures_fire(t_textures *textures)
{
	...
	xpm_to_img("textures/edited/burning_end_1.xpm", &(textures->fire_end[0].img));
	xpm_to_img("textures/edited/burning_end_2.xpm", &(textures->fire_end[1].img));
	xpm_to_img("textures/edited/burning_end_3.xpm", &(textures->fire_end[2].img));
	xpm_to_img("textures/edited/burning_end_4.xpm", &(textures->fire_end[3].img));
	xpm_to_img("textures/edited/burning_end_5.xpm", &(textures->fire_end[4].img));
}

void	load_textures_hose(t_textures *textures)
{
	xpm_to_img("textures/edited/hose.xpm", &(textures->hose_idle.img));
	...
	xpm_to_img("textures/edited/hose_firing5.xpm", &(textures->hose_on[0].img));
	xpm_to_img("textures/edited/hose_firing6.xpm", &(textures->hose_on[1].img));
	xpm_to_img("textures/edited/hose_firing7.xpm", &(textures->hose_on[2].img));
	xpm_to_img("textures/edited/hose_firing8.xpm", &(textures->hose_on[3].img));
	xpm_to_img("textures/edited/hose_firing9.xpm", &(textures->hose_on[4].img));
	xpm_to_img("textures/edited/hose_firing10.xpm", &(textures->hose_on[5].img));
	xpm_to_img("textures/edited/hose_firing11.xpm", &(textures->hose_on[6].img));
	xpm_to_img("textures/edited/hose_firing12.xpm", &(textures->hose_on[7].img));
	xpm_to_img("textures/edited/hose_ending1.xpm", &(textures->hose_end[0].img));
	xpm_to_img("textures/edited/hose_ending2.xpm", &(textures->hose_end[1].img));
	xpm_to_img("textures/edited/hose_ending3.xpm", &(textures->hose_end[2].img));
	xpm_to_img("textures/edited/hose_ending4.xpm", &(textures->hose_end[3].img));
	xpm_to_img("textures/edited/hose_ending5.xpm", &(textures->hose_end[4].img));
	xpm_to_img("textures/edited/hose_ending6.xpm", &(textures->hose_end[5].img));
	xpm_to_img("textures/edited/hose_ending7.xpm", &(textures->hose_end[6].img));
	xpm_to_img("textures/edited/hose_ending8.xpm", &(textures->hose_end[7].img));
}
